    ...
    <ScrollView>
      ...
      <S.ContentContainer>
        <S.Content>
          ...
          <S.TextBlock>1. Higienizar as mãos</S.TextBlock>
          <S.TextBlock>
            2. Avalie e escolha qual a região você irá fazer a técnica
          </S.TextBlock>
          <S.TextBlock>
            3. Posicione a paciente em decubito dorsal para o ponto BL32, e em
          ...
          <S.TextBlock>
            4. Localize os ponto SP6, na largura de aproximadamente quatro dedos
          ...
          <S.TextBlock>
            5. Aperte o ponto escolhido e fique pressionando‐o repetidamente,
            para tonificar em movimento circular no sentido horário, durante
            pelo menos 3 minutos.
          </S.TextBlock>
          <S.TextBlock>
            6. Para definir a percepção da dor durante o trabalho de parto,
            utilize a escala visual analógica (EVA) que varia de 0 a 10, em que
            o 0 é ausência de dor e 10 significa dor intensa.
          </S.TextBlock>
          <S.TextBlock>
            7. Realizar registro da intervenção e registro de acompanhamento dos
          ...
          <S.TextBlock>1. Higienize as mãos.</S.TextBlock>
          <S.TextBlock>
            2. Posicione a paciente em decúbito lateral ou sentada;
          </S.TextBlock>
          <S.TextBlock>
            3. Observe o pavilhão auricular para conhecer onde será o ponto na
            qual será realizada o procedimento. Essa fase é chamada de inspeção
            e além de escolher tal local de aplicação ela é importante pois
            objetiva também encontrar alguma patologia na área auricular.
          </S.TextBlock>
          <S.TextBlock>
            4. Realize antissepsia previamente, com álcool etílico 70%, no
            pavilhão auricular.
          </S.TextBlock>
          <S.TextBlock>
            5. Faça o diagnóstico por meio da palpação com o auxílio de uma
            sonda ou a caneta de detecção através da pressão para identificação
            de pontos sensíveis auriculares.
          </S.TextBlock>
          <S.TextBlock>
            6. Utilize a caneta de palpação para pressionar os pontos
            auriculares e à observação da marca pressionada.
          </S.TextBlock>
          <S.TextBlock>
            7. Tenha como referência os pontos:
          ...
          <S.TextBlock>
            8. Achado os pontos acima utilize esferas de cristal polido com
            1,5mm ou sementes de mostarda, aderidas à pele com fitas
            hipoalérgicas
          </S.TextBlock>
          <S.TextBlock>
            9. Faça a fixação dos cristais ou das sementes e realize uma leve
            pressão que deve ser mantida por um minuto ou por um intervalo de
            tempo semelhante ou até mesmo em que a pressão gere uma sensação
            dolorosa e ative o ponto de energia, causando liberação de
            endorfinas.
          </S.TextBlock>
          <S.TextBlock>
            10. Para definir a percepção da dor durante o trabalho de parto,
            utilize a escala visual analógica (EVA) que varia de 0 a 10, em que
            o 0 é ausência de dor e 10 significa dor intensa.
          </S.TextBlock>
          <S.TextBlock>
            11. Realizar registro da intervenção e registro de acompanhamento
            dos sintomas e intensidade da dor. (MAFETONI et al., 2019).
          </S.TextBlock>
        </S.Content>
      </S.ContentContainer>
    </ScrollView>
