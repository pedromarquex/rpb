  ...
  return (
    <ScrollView>
      <S.HeaderContainer>
        ...
        <S.Title>Terapias térmicas ou termoterapia</S.Title>
      </S.HeaderContainer>
      <S.ContentContainer>
        <S.Content>
          <S.TextBlock>
          ...
          <S.TextBlock>
            1. Prepare a sala de parto e o banheiro com o objetivo de criar um
            bom ambiente, mantendo as luzes baixas e uma música suave de acordo
            com o gosto da parturiente. As roupas de banho devem favorecer o
            conforto da parturiente. Pode usar suas próprias roupas ou ficar
            despida, a depender da preferência da mulher.
          </S.TextBlock>
          <S.TextBlock>
            2. Certifique que a parturiente não tenha histórico de hipotensão,
            pois esse método causa vasodilatação dos vasos sanguíneos e
            consequentemente poderá acelerar o processo hipotenso.
          </S.TextBlock>
          <S.TextBlock>3. Realize a higienização das mãos.</S.TextBlock>
          <S.TextBlock>
            4. Realize o toque vaginal (enfermeiro ou médico obstetra) para
            observar a dilatação cervical, a mesma deve estar entre 4 a 5 cm.
          </S.TextBlock>
          <S.TextBlock>
            5. Primeiramente aplica-se o banho de imersão, necessário que a
            temperatura da água esteja em torno de 37 a 38° C, sendo importante
            que a paciente permaneça, no mínimo, 20 minutos na banheira.
          </S.TextBlock>
          <S.TextBlock>
            6. Adicionar óleos essenciais na banheira pode ser uma alternativa a
            mais para o relaxamento da parturiente. O produto deve ser
            adicionado no momento que a mesma já esteja dentro da banheira,
            colocando em média 15 a 20 gotas.
          </S.TextBlock>
          <S.TextBlock>
            7. A presença do pai no momento é importante, pois pode trazer mais
            segurança a mãe e facilita o processo de apoio, ficando assim
            facultada ao caso a participação ou não do ato.
          </S.TextBlock>
          <S.TextBlock>
            8. Após o banho de imersão, posicione a parturiente em uma cadeira
            ou na bola suíça.
          </S.TextBlock>
          <S.TextBlock>
            9. Ligue o chuveiro e regule a temperatura em torno de 37 a 39 ºC,
            com ajuda de um termômetro, sempre respeitando a sensibilidade da
            paciente em relação a temperatura da água e a intensidade do jato de
            água, recomenda-se que o jato tenha que ficar de leve a moderada
            intensidade por um período de no mínimo 20minutos.
          </S.TextBlock>
          <S.TextBlock>
            10. Com a parturiente enxuta, direcione e auxilie a parturiente até
            a sala de parto.
          </S.TextBlock>
          <S.TextBlock>
            11. Realize novamente o toque vaginal (enfermeiro ou médico obstetra
            ) para observar a dilatação cervical que deve estar acima de 4 a 5
            cm. Caso não esteja e se for da vontade da paciente, repita todo o
            processo anterior.
          </S.TextBlock>
          <S.TextBlock>
            12. Se a dilatação estiver acima de 5 cm aplique compressas quentes,
            por um intervalo curto de tempo, em média de 2 a 5 minutos,
            considerando que a aplicação deve ser rápida porque ativa a
            sensibilidade e em seguida gera o efeito analgésico na gestante.
          </S.TextBlock>
          <S.TextBlock>
            13. Coloque uma toalha do tipo microfibra ou bolsa térmica nas
            regiões onde a parturiente esteja sentindo mais dor, sempre
            obedecendo o tempo acima já descrito.
          </S.TextBlock>
          <S.TextBlock>
            14. Para definir a percepção da dor durante o trabalho de parto,
            utilize a escala visual analógica (EVA) que varia de 0 a 10, em que
            o 0 é ausência de dor e 10 significa dor intensa.
          </S.TextBlock>
          <S.TextBlock>
            15. Realizar registro da intervenção e registro de acompanhamento
