      ...
      <S.ContentContainer>
        <S.Content>
          ...
          <S.TextBlock>
            ...
            primeiro e segundo estágios do trabalho de parto e após 30 minutos
            de aplicação pode aliviar a intensidade da dor (BRASIL, 2019;
            POLLARD, 2008; SMITH et al., 2011; KAVIANI et al., 2014).
          </S.TextBlock>
          <S.TextBlock>
            A lavanda auxilia no alívio da dor, pois ajuda a parturiente a se
            acalmar e focar no trabalho de parto. Além disso, o óleo vegetal
            pode ser aplicado no corpo por meio de massagem (BRASIL, 2019).
          </S.TextBlock>
          <S.TextBlock>
            ...
            Hortelã-pimenta (M. piperita) mostra-se se eficaz para o alívio da
            ...
            positivos em relação ao processo do parto (PRICE, 2019).
          </S.TextBlock>
          <S.TextBlock>
          ...
          <S.TextBlock>
            ...
            intensidade do aroma, pois quando mais perto se estiver do pano,
            mais intenso será o cheiro (SMITH et al., 2011).
          </S.TextBlock>
          <S.TextBlock>
          ...
          <S.TextBlock>
            ...
            o frasco de óleo essencial próximo ao nariz, ou pingue de 1 a 3
            gotas nas palmas das suas mãos e oriente que passe uma mão na outra
          ...
          <S.TextBlock>
            ...
            por meio do Aromatizador. Neste caso, adicione 2 ou 3 gotas do óleo
            escolhido no interior de um difusor de aromas com água em
